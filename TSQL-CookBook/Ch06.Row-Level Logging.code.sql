...
INSERT INTO Stock(ProductId,Qty) VALUES('Bananas',100)
INSERT INTO Stock(ProductId,Qty) VALUES('Apples',40)
DELETE FROM Stock WHERE ProductId='Apples'
UPDATE Stock SET QTY=200 WHERE ProductId='Bananas'
GO